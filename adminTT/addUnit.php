...
<body>
  ...
  <form action="addUnit.php" method="post" class="form-style-9">
    <?php echo display_error(); ?>
<ul>
<li>
    <input type="text" name="blockname" class="field-style field-split align-left" placeholder="Name" />
</li>
<li>
    <textarea name="description" class="field-style one" placeholder="Description of the house"></textarea>
</li>
<li>
<input type="submit" name="register_btn" value="+ Add Unit"/>
</li>
</ul>
</form>
